      ...
      <DialogContent className="bg-slate-700">
        <div className="mb-10 mt-4 flex flex-col items-center justify-center">
          ...
          <p className="mb-4 w-5/6 text-center text-xs font-medium text-gray-400">
            Monitor Education Using Monitor Intelligence System merupakan
            inovasi teknologi berupa{' '}
            <b className="font-bold text-gray-100">monitor pintar</b> yang
            berperan sebagai pemandu museum untuk memperoleh informasi yang
            relevan.
          </p>
